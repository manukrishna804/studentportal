...
if(isset($_POST['submit'])){
    ...
    $stmt = $con->prepare("SELECT * FROM register WHERE s_id=? AND s_pass=?");
...
<body>
    <div class="container">
        <div class="welcome-section">
            ...
            <p>Welcome back! Log in to access your academic dashboard, assignments, and course materials.</p>
            
            <ul class="feature-list">
                <li><i class="fas fa-graduation-cap"></i> Access your courses</li>
                <li><i class="fas fa-book"></i> View assignments and grades</li>
                <li><i class="fas fa-calendar-alt"></i> Check upcoming events</li>
                <li><i class="fas fa-users"></i> Connect with classmates</li>
            </ul>
        </div>
